# adapted from: https://github.com/Gallilus/IcosphereMesh
...
## convert tiangles to PoolIntArray
	...
	for triangle in triangles:
		triangles_pi.append(int(triangle[0]))
		triangles_pi.append(int(triangle[1]))
		triangles_pi.append(int(triangle[2]))
...
func subdivide() -> PackedVector3Array:
	lookup = {}
